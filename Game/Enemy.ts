namespace Doom {
  ...
  export class Enemy extends ƒ.Node {
    ...
    public cmpAudio: ƒ.ComponentAudio = new ƒ.ComponentAudio(new ƒ.Audio("../DoomAssets/hypnotic.mp3"), true);
   // public mtxInner = inner.mtxLocal;
   // public mtxOuter = outer.mtxLocal;
    private show: ƒ.Node;
    ...
    public chooseTargetPosition(): void {
      ...
      let enemyAudio: ƒ.ComponentAudio = this.getComponent(ƒ.ComponentAudio);
